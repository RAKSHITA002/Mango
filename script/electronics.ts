document.addEventListener('DOMContentLoaded', async () => {
  const ElectronicsProduct = document.querySelector<HTMLElement>('.electronicsProducts');
  ...
  async function fetchElectronicsCategory(url: string) {
  ...
  await fetchElectronicsCategory('https://fakestoreapi.com/products/category/electronics');
});
